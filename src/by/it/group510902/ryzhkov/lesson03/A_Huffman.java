package by.it.group510902.ryzhkov.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        PriorityQueue<Node> priorityQueue = new PriorityQueue<>((Node1, Node2) -> Node1.compareTo(Node2));
        for (Character ch : count.keySet()) {
            LeafNode node = new LeafNode(count.get(ch), ch);
        ...
        // priorityQueue.
        priorityQueue.remove().fillCodes("");
